...
public:
    ...
    inline static constexpr Material Chrome{
        ...
        QVector3D(0.25,	0.25,	0.25),
        QVector3D(0.774597,	0.774597,	0.774597),
        76.8f
    };
    ...
    inline static constexpr Material Copper{
        QVector3D(0.19125,	0.0735,	0.0225),
        QVector3D(0.7038,	0.27048,	0.0828),
        QVector3D(0.256777,	0.137622,	0.086014),
        12.8
    };

    inline static constexpr Material YellowRubber{
        QVector3D(0.05,	0.05,	0.0),
        QVector3D(0.5,	0.5,	0.4),
        QVector3D(0.7,	0.7,	0.04),
        100.f
    };
